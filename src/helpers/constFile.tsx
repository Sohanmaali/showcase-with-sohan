// =================================PROFILE SECTION=================================
import { FaGithub, FaLinkedin, FaTwitter, FaCode, FaMapMarkerAlt, FaEnvelope, FaInstagram } from 'react-icons/fa';
...
export const link =  [
  ...
  { 
    ...
    url: 'https://www.linkedin.com/in/sohan-maali1/',
    name: 'LinkedIn',
  ...
  { 
    ...
    url: 'https://auth.geeksforgeeks.org/user/sohanmaali1',
    name: 'GeeksforGeeks',
  ...
  //   url: 'https://leetcode.com/sohanmaali4/',
  //   name: 'LeetCode',
  ...
  { 
    ...
    url: 'https://www.instagram.com/sohan.maali',
    name: 'Instagram',
    color: 'hover:text-yellow-400',
    bgColor: 'hover:bg-yellow-400/10'
  },
