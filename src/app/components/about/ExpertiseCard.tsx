  ...
  return (
    <>
      {expertise.map((item, index) => (
        <div 
          key={index} 
          className="relative drop-shadow-xl md:w-64 w-full md:h-80 h-64 overflow-hidden rounded-xl bg-[#3d3c3d] group transition-all duration-300 hover:scale-105 cursor-default mt-5 md:mt-0"
        >
